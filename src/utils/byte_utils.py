"""
Utilitários para manipulação de bytes e conversão binária.

Centraliza o uso de struct.pack/unpack para evitar duplicação
e garantir consistência no formato little-endian.
"""
